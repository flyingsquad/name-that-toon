...
* Import tables from the Name Tables compendium provided with this module, or create rollable tables with the names you wish to use. The description for your custom name table must contain the string "name table" somewhere in the summary description.
...
If you selected any tokens that are linked to an actor, a checkbox will appear: "Also rename linked actors." If checked, any actors that are linked to selected tokens will also have their names changed.
